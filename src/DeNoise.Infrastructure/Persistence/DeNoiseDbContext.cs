...
/// </summary>
public sealed class DeNoiseDbContext(DbContextOptions<DeNoiseDbContext> options) : DbContext(options)
{
    ...
    {
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(DeNoiseDbContext).Assembly);
    }
}
