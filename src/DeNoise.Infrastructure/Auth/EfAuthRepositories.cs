...
namespace DeNoise.Infrastructure.Auth;

public sealed class EfUserRepository(DeNoiseDbContext db) : IUserRepository
{
...
public sealed class EfSessionRepository(DeNoiseDbContext db) : ISessionRepository
{
...
public sealed class EfPersonalAccessTokenRepository(DeNoiseDbContext db) : IPersonalAccessTokenRepository
{
...
public sealed class EfLoginAttemptRepository(DeNoiseDbContext db) : ILoginAttemptRepository
{
...
public sealed class EfIdempotencyStore(DeNoiseDbContext db) : IIdempotencyStore
{
...
public sealed class EfTeamMemberRepository(DeNoiseDbContext db) : ITeamMemberRepository
{
...
public sealed class EfSavedFilterRepository(DeNoiseDbContext db) : ISavedFilterRepository
{
