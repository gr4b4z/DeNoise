...
public sealed class DispatcherWorker(IServiceScopeFactory scopes, IOptions<JobQueueOptions> options, TimeProvider time, DeNoiseMetrics metrics, ILogger<DispatcherWorker> logger) : BackgroundService
{
