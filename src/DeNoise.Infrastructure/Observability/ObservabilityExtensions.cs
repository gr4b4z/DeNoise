...
public static class ObservabilityExtensions
{
    ...
    /// </summary>
    public static IHostApplicationBuilder AddDeNoiseObservability(this IHostApplicationBuilder builder, string serviceName)
    {
        ...
        builder.Services.AddSingleton<DeNoiseMetrics>();
        ...
        var otel = builder.Services.AddOpenTelemetry()
            ...
            .WithMetrics(m =>
            {
                m.AddMeter(DeNoiseMetrics.MeterName)
    ...
    public static WebApplication UseDeNoiseRequestLogging(this WebApplication app)
    {
