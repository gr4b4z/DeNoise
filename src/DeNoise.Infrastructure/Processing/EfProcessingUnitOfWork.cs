...
/// <summary>
/// One processing transaction on a fresh <see cref="DeNoiseDbContext"/>: begin → work → SaveChanges → commit.
...
internal sealed class EfProcessingSession(DeNoiseDbContext db) : IProcessingSession
{
