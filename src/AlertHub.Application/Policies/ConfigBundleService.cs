...
public sealed class ConfigBundleService(IPolicyRepository policies, PolicyService service)
{
    ...
    {
        var root = new JsonObject { ["alerthub_config"] = BundleVersion, ["policies"] = new JsonObject() };
        ...
        return "# Alert Hub policies — export of every active version; import with POST /api/v1/config/import\n" + YamlJson.ToYaml(root);
    }
