...
{
    public const string AzureCanaryRulePrefix = "alerthub-canary-";
    ...
    /// <summary>Managed canary rules (<c>alerthub-canary-*</c>, spec §13.4) become coverage signals, never episodes (order 10).</summary>
    public const string AzureCanaryYaml = """
        mapping:
          identity_version: 1
          applies_when: { regex: [ "$.data.essentials.alertRule", "^alerthub-canary-" ] }
          fields:
    ...
    public const string AzureCanarySample = """
        { "schemaId": "azureMonitorCommonAlertSchema", "id": "PROVISIONAL-canary-1",
          "data": { "essentials": {
              ...
              "alertRule": "alerthub-canary-production", "alertRuleID": "/subscriptions/00000000-0000-0000-0000-000000000001/resourceGroups/rg-mon/providers/Microsoft.Insights/scheduledQueryRules/alerthub-canary-production",
