...
namespace AlertHub.Infrastructure.Health;
...
public sealed class OutboxLagHealthCheck(AlertHubDbContext db, TimeProvider time, IOptions<HealthOptions> options) : IHealthCheck
{
