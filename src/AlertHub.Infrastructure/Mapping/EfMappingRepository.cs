...
namespace AlertHub.Infrastructure.Mapping;

public sealed class EfMappingRepository(AlertHubDbContext db) : IMappingRepository
{
...
/// </summary>
public sealed class CachedMappingResolver(AlertHubDbContext db, IMemoryCache cache) : IMappingResolver
{
