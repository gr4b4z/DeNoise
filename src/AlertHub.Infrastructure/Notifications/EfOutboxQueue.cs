...
public sealed class EfOutboxQueue(AlertHubDbContext db, TimeProvider time) : IOutboxQueue
{
...
public sealed class EfEpisodeReader(AlertHubDbContext db) : IEpisodeReader
{
