...
using AlertHub.Application.Divergence;
...
public sealed class DivergenceReporter(AlertHubDbContext db, IIntegrationRepository integrations, IStateQueryAdapter adapter, IOptions<PilotOptions> options, TimeProvider time, ILogger<DivergenceReporter> logger) : IDivergenceReporter
{
    ...
    public async Task<DivergenceReport> RunAsync(Guid integrationId, CancellationToken ct = default)
    {
        ...
        db.AuditEntries.Add(new AuditEntry
        {
            ...
            ActorId = "divergence",
            ActorDisplay = "Alert Hub divergence check",
            Action = Action,
