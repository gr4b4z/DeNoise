...
namespace DeNoise.Application.Notifications.Templates;
...
public static class BuiltInTemplates
{
    ...
    [
        new()
        {
            ...
            Description = "The full notification model (06 §7) — for receivers that parse DeNoise's own envelope.",
              ...
              "attachments": [
                {
                  ...
                  "content": {
                    ...
                    "actions": [
                      { "type": "Action.OpenUrl", "title": "Open in DeNoise", "url": "{{ episode.url }}" }{% if episode.runbookUrl %},
            ...
            Body = """
            {
              ...
              "blocks": [
                ...
                { "type": "actions", "elements": [
                  { "type": "button", "text": { "type": "plain_text", "text": "Open in DeNoise" }, "url": "{{ episode.url }}" }
                ] }
              ]
            }
            """,
        ...
        new()
        {
            ...
            Body = """
            [DeNoise][{{ episode.severity }}] {{ episode.summary }}
