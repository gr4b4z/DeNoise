...
{
    public Task<ActionResult> AcknowledgeAsync(DeNoisePrincipal actor, Guid episodeId, int expectedVersion, bool force, string correlationId, CancellationToken ct = default)
    ...
    public Task<ActionResult> AssignAsync(DeNoisePrincipal actor, Guid episodeId, int expectedVersion, Guid? teamId, Guid? userId, string correlationId, CancellationToken ct = default)
    ...
    public Task<ActionResult> NoteAsync(DeNoisePrincipal actor, Guid episodeId, int expectedVersion, string text, string correlationId, CancellationToken ct = default)
    ...
    public Task<ActionResult> CloseAsync(DeNoisePrincipal actor, Guid episodeId, int expectedVersion, string reason, string correlationId, CancellationToken ct = default)
    ...
    public Task<ActionResult> RestoreAsync(DeNoisePrincipal actor, Guid episodeId, int expectedVersion, string? reason, string correlationId, CancellationToken ct = default)
    ...
    public Task<ActionResult> SilenceAsync(DeNoisePrincipal actor, Guid episodeId, int expectedVersion, DateTimeOffset until, string reason, string correlationId, CancellationToken ct = default)
    ...
    public Task<ActionResult> RefreshStateAsync(DeNoisePrincipal actor, Guid episodeId, string correlationId, CancellationToken ct = default)
    ...
    private async Task<ActionResult> RunAsync(DeNoisePrincipal actor, string permission, Guid episodeId, int? expectedVersion, string correlationId,
    ...
    private AuditEntry Audit(DeNoisePrincipal actor, string action, Episode episode, string correlationId, object? after, object? before = null) => new()
    {
        Id = Ids.New(time),
        At = time.GetUtcNow(),
