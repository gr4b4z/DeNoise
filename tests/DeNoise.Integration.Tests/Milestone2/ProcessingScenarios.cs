...
namespace DeNoise.Integration.Tests.Milestone2;
...
public sealed class ProcessingScenarios(PostgresFixture postgres) : IAsyncLifetime
{
    ...
    {
        var hb = await IngestAndProcessAsync("""{"eventType":"heartbeat","alertId":"canary-1","eventId":"h1","rule":{"id":"denoise-canary"}}""");
