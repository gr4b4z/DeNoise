...
namespace DeNoise.Application.Tests.Suppressions;
...
public sealed class WallClockTests
{
    ...
    public void Non_existent_and_ambiguous_times_resolve_deterministically()
    {
        ...
        act.Should().Throw<DeNoise.Application.Mapping.MappingValidationException>();
    }
    ...
    public void Predicates_render_as_sentences()
    {
        ...
        act.Should().Throw<DeNoise.Application.Mapping.MappingValidationException>("raw JSONPath references are not allowed in scopes");
    }
}
