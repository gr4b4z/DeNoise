...
public sealed class HeartbeatScenarios(PostgresFixture postgres) : IAsyncLifetime
{
    ...
    private AlertHubPrincipal _operator = null!;
    ...
    public async Task InitializeAsync()
    {
        ...
        _operator = AlertHubPrincipal.ForSession(new User { UserId = Guid.NewGuid(), Username = "olga", DisplayName = "Olga", RoleNames = [Roles.Operator], Scopes = ["scope-a"] }, "test-session");
    }
